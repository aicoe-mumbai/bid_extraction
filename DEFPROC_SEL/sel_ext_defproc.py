...
# Keywords to search
keywords = [
    "Weapon", "Helicopter landing Grid", "Launcher", "Helicopter Hangar Door", "Torpedo",
    "Foldable Hanger Door", "Rocket", "Steering Gear", "Sonar", "Fin Stabilizer",
    ...
    "Controllable Pitch propeller", "Shafting", "Stern Gear Helicopter", "Propulsion",
...
# Output CSV file
output_file = os.path.join(output_directory, "defproc_data.csv")
